...
import { updateNeonConnectionString } from "@/lib/database";
...
const ChatSidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed lg:relative z-50 h-full bg-chat-sidebar flex flex-col transition-transform duration-300 animation-slide-in",
          ...
          <>
            ...
            <div className="p-3 border-t border-border/50 space-y-2">
              ...
              <p className="text-xs text-muted-foreground text-center">
                UCSD Volleyball Coach Analytics
              </p>
            </div>
          </>
        )}
